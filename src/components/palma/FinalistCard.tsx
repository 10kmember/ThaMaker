...
export function FinalistCard({
  ...
  return (
    <Link
      ...
      className={cn('group flex flex-col gap-5 focus:outline-none', className)}
    >
      ...
      <EditorialImage
        ...
        className="grayscale-[18%] transition-[filter] duration-700 group-hover:grayscale-0"
      />

      <h3 className="text-2xl leading-tight transition-opacity group-hover:opacity-70 sm:text-3xl">
        {finalist.creator.displayName}
      </h3>
